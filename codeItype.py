...
df['persons'] = df['persons'].map(person_replace)
...
person_mean = float(persons_colm.mean())
person_median = float(persons_colm.median())
print(f'Mean:{person_mean}Median:{person_median}')
